...
myClockElement.append(nemberArea());
...
//   parentElement.classList.add("time-handler");
//   let hrElement = document.createElement('div');
//   hrElement.classList.add("hr");
//   let minElement = document.createElement('div')
//   minElement.classList.add('min');
...
//   parentElement.append(hrElement);
//   parentElement.append(minElement);
//   parentElement.append(secElement);
